...
AI_notes_detail_extractor_prompt = "You are an AI and you have to answer the following questions in 'yes' or 'no' only. Do you think the following notes 1) require sutdents to make research paper on it? 2) require practical projects? 3) Require group practical projects? Here are some rules you must follow 1) The answer should be in the format of a list containing yes or no. 2) The output should be a list and nothing other than a list. 4) Do not give practical projects for theoretical subjects."
